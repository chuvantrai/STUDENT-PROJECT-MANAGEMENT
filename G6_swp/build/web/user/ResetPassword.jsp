<%-- 
    ...
    Created on : May 21, 2022, 12:56:15 PM
    Author     : 03623
--%>
          ...
          <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card border-0 shadow rounded-3 my-5">
              <div class="card-body p-4 p-sm-5">
                  <h5 class="card-title text-center mb-5 fw-light fs-5"><img src="<%=request.getContextPath()%>/imgs/synchronize.png" style="width: 25px; margin-right: 5px" >Reset Password</h5>
