<%-- 
    ...
    Created on : Jun 17, 2022, 10:39:35 AM
    Author     : 03623
--%>
...
<body style="margin: 0px;border: 0px">
   ...
   <img src="../../G6_swp/imgs/success.gif" alt="" style="width: 100%; padding-bottom: 20px">
    ...
    <i class="bi bi-bell-fill"></i> You do not have access to this page!</h3>
    <div style="text-align: center; margin-top: 40px;">
        <form action="../home" method="GET">
        <button class="btn btn-secondary btn-lg" type="submit" style="background-color: #283e6a; border-color: #283e6a;">
